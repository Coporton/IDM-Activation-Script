...
-   Download the file from [GitHub](https://github.com/Coporton/IDM-Activation-Script/archive/refs/heads/main.zip) or [Bitbucket](https://bitbucket.org/Coporton/idm-activation-script/get/main.zip)
...
-   Fixed an issue where Powershell code to launch IAS may not work due to GitHub block in some regions. It will use the new [BitBucket](https://bitbucket.org/Coporton/idm-activation-script/) repo as a fallback link.
...
![](https://coporton.com/images/IAS.png?raw=true)

![](https://coporton/images/IAS_Freeze_Trial.png?raw=true)
